<!--
**chldntjr1321/chldntjr1321** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
- ⚡ Fun fact: ...
-->
<img src="https://capsule-render.vercel.app/api?type=blur&color=60A5FA&fontColor=1E3A8A&height=300&section=header&text=WooSeok's%20GitHub-nl-&desc=Frontend%20Developer&descAlign=15.5&descAlignY=23&fontSize=90&animation=fadeIn" />
...
<div align="center">
  <h1>💼 Projects 💼(수정 예정)</h1>
  <table>
    <tr>
      <td width="50%" align="center">
        <h3>👥 팀 프로젝트1</h3>
        <a href="[더 줄게 프로젝트 링크](https://the-julge-cyan.vercel.app/)">
          <img width="100%" height="567" alt="더 줄게" src="https://github.com/user-attachments/assets/3e2d3a7c-8c7d-4cc7-ad08-a5703d724d0e" />
        </a>
        <p><strong>더 줄게</strong></p>
        <p>아르바이트 공고 등록 및 지원을 핵심 기능으로 하는 매칭 플랫폼 프로젝트</p>
      </td>
      <td width="50%" align="center">
        <h3>👥 팀 프로젝트2</h3>
        <a href="[글로벌 노마드 프로젝트 링크](https://global-nomad-1team.vercel.app/)">
          <img width="100%" height="567" alt="글로벌 노마드" src="https://github.com/user-attachments/assets/51fc021d-fdd5-4a3b-86e8-b34f0a3abb06" />
        </a>
        <p><strong>글로벌 노마드</strong></p>
        <p>다양한 액티비티를 탐색하고 예약할 수 있도록 돕는 <br> 체험 공유 커머스 플랫폼 아키텍처 프로젝트</p>
      </td>
    </tr>
  </table>
  <br>
  <a href="https://wooooseok.vercel.app/"><strong>🔗 더 많은 프로젝트 보러가기(포트폴리오)</strong></a>
</div>
<br><br>
</div>
